...
i18n国际化插件的使用
主要是表格的使用 menu(router path index) table input dialog(搭配Vue的插槽的使用) button form( rules 方法 validate方法) form-item 中prop和 input中的v-model绑定数据的分别作用。 学习注册的这个表单页面处理逻辑。
